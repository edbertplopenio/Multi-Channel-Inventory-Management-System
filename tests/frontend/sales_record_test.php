...
<body>
    ...
    <div class="sales-record-container">
        ...
        <!-- Additional tabs remain unchanged -->
            ...
            <form id="new-order-form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock-level" name="stock-level" required min="0">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantity-sold" name="quantity-sold" required min="0" oninput="updateStockLevel()">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="lead-time" name="lead-time" min="0">
                    </div>

                    <div class="form-group">
                        <label for="return-status">Return Status:</label>
                        <select id="return-status" name="return-status">
    ...
    <script>
        ...
        function updateStockLevel() {
            ...
            const quantitySold = document.getElementById('quantity-sold').value;
            if (quantitySold > stockLevel.value) {
                alert("Quantity Sold cannot exceed Stock Level.");
                document.getElementById('quantity-sold').value = stockLevel.value;
            }
        }
