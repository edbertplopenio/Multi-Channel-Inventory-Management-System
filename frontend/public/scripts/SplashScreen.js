document.addEventListener("DOMContentLoaded", function () {
  ...
  // Function to display splash screen animation
  function showSplashScreen() {
    splashScreen.innerHTML = `
        <div class="loading-page">
            ...
            <div class="name-container">
                <div class="logo-name">Multichannel Inventory System</div>
            </div>
        </div>
    `;
    ...
    // Redirect to the login page after splash screen
    setTimeout(() => {
      if (!checkLoginStatus()) {
    ...
    }, 5000); // Adjust this time based on your animations
  }

  // Function to check if the user is logged in
  function checkLoginStatus() {
    return document.cookie.includes('user_email='); // Adjust based on your actual authentication method
  }
